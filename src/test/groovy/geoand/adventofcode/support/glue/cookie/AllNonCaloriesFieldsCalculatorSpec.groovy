 ...
 */
class AllNonCaloriesFieldsCalculatorSpec extends Specification {

    def "calculate Butterscotch and Cinnamon"() {
        given:
            final def calculator = AllNonCaloriesCalculator.of([new Ingredient('Butterscotch', -1, -2, 6, 3, 8), new Ingredient('Cinnamon', 2, 3, -2, -1, 3)])
